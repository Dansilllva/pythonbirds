...
class Passaro(Ator):
    ...
    def calcular_posicao(self, tempo):
        ...
        if self._esta_voando():
            ...
            self._calcular_posicao_certical(delta_t)
            self._calcular_posicao_horiontal(delta_t)
    ...
    def _calcular_posicao_certical(self, delta_t):
    ...
    def _calcular_posicao_horiontal(self, delta_t):
